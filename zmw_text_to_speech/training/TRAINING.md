...
1. Run the [prep dataset script](./split_audio.py) to split the big audio file into smaller chunks.
1. Run the [transcribe script](./transcribe_dataset.py) to generate the metadata file needed for training.
